...
export const dict = {
  ar: {
    ...
    // ── Card drawer (supporters / claim) ──
    supporters: "الداعمون",
    supportersCount: (n: number) => `${n.toLocaleString("en-US")} داعم`,
    noSupporters: "لسه مفيش داعمين لهذه البطاقة.",
    anonymous: "مجهول",
    ownerLabel: "المالك",
    claimedBadge: "مُطالَب به",
    claimCard: "هذا حسابي",
    claimDone: "تمت المطالبة — البطاقة بقت لك ✓",
    claimExists: (name: string | null) =>
      name ? `البطاقة مطالَب بها بالفعل من ${name}.` : "البطاقة مطالَب بها من شخص آخر.",
    claimFailed: "تعذّرت المطالبة بالبطاقة — جرّب تاني",
    claimLoginHint: "الدخول بالبريد لتأكيد الملكية",
    youLabel: "أنت",
    ...
    saved: "تم الحفظ ✓",
    cancel: "إلغاء",
    invalidImageUrl: "الرابط لازم يبدأ بـ https://",
    editFailed: "تعذّر حفظ التعديلات — جرّب تاني",
    editRelogin: "انتهت جلستك — سجّل الدخول من جديد وجرّب تاني",
    editClearHint: "امسح محتوى الحقل واحفظ لحذفه — الحقل الفاضي معناه إزالة القيمة.",
    // ── Profile ──
    profileTitle: "ملفي",
    ...
    boardRank: (n: number) => `#${n} على اللوحة`,
  ...
  en: {
    ...
    claimCard: "This is me",
    claimDone: "Claimed — this card is yours ✓",
    claimExists: (name: string | null) =>
      name ? `This card is already claimed by ${name}.` : "This card is already claimed by someone else.",
    claimFailed: "Couldn't claim this card — try again",
    claimLoginHint: "Log in with email to confirm ownership",
    youLabel: "You",
    editCard: "Edit card",
    ...
    saved: "Saved ✓",
    cancel: "Cancel",
    invalidImageUrl: "URL must start with https://",
    editFailed: "Couldn't save your edits — try again",
    editRelogin: "Your session expired — log in again and retry",
    editClearHint: "Clear a field and save to remove it — an empty field removes the value.",
    // ── Profile ──
    ...
    boardRank: (n: number) => `#${n} on the board`,
