...
export const dict = {
  ar: {
    ...
    fetchSlowNote: "ما زال الجلب مستمراً — بعض الحسابات تستغرق حتى دقيقة، وتكتمل البطاقة فور وصول البيانات.",
    fetchFailedNote: "تعذر جلب تفاصيل الحساب حالياً — سيُعرض اسم المستخدم.",
    // ── Board rows ──
  ...
  en: {
    ...
    fetchSlowNote: "Still fetching — some accounts take up to a minute. The card fills in as soon as details arrive.",
    fetchFailedNote: "Couldn't fetch account details right now — showing the username.",
    // ── Board rows ──
