...
export const dict = {
  ar: {
    ...
    // ── Homepage hero ──
    headline: "تصدّر اللوحة بحسابك على إنستغرام أو تيك توك",
    headlineTagline: "أعلى مزايدة = المركز الأول 🥇",
    supporting:
      "يمكن لأي شخص إضافة حسابه أو دعم صانعه المفضل للمنافسة على المركز الأول. إنستغرام وتيك توك أولاً، مع دعم كامل لإكس، ولينكدإن، والمواقع، والتطبيقات.",
    inputPlaceholder: {
    ...
    previewSourceNote: "البيانات مسترجعة مباشرة من المنصة للمعاينة.",
    fetchFailedNote: "تعذر جلب تفاصيل الحساب حالياً — سيتم عرض اسم المستخدم الأساسي.",
    // ── Board rows ──
    ...
    rulesPlatformsBody:
      "إنستغرام وتيك توك في المقدمة — حسابات التواصل الاجتماعي هي جوهر اللوحة. ندعم أيضاً: إكس، ولينكدإن، والمواقع الإلكترونية، والتطبيقات (App Store / Google Play). يحمل كل حساب أيقونة منصته بوضوح.",
  ...
  en: {
    ...
    previewSourceNote: "Information fetched directly from the platform for preview.",
    fetchFailedNote: "Couldn't fetch account data right now — showing the username.",
    // ── Board rows ──
